...
// Area of a circle with a radius of 10px
...
// Rounding
console.log(Math.trunc(23.6)); // Removes decimals
console.log(Math.round(23.6)); // Rounds to the nearest integer
...
labelBalance.addEventListener('click', function () {
  [...document.querySelectorAll('.movements__row')].forEach(function (row, i) {
    if (i % 2 === 0) row.style.backgroundColor = '#F5F5F5';
  });
});
...
console.log(Number('230_00')); // You cannot use number seperators on strings
...
console.log(15646546546846841684684684652498465468468468468454684n);
console.log(BigInt(15646546546846841684684684652498465468468468468454684n));
console.log(BigInt(68454684n));

// Operattions
console.log(1000n + 1000n);
console.log(1231513513513513513513513n + 1000000n);
...
// console.log('US:     ', new Intl.NumberFormat('en-US', options).format(numNew));
// console.log('Germany:     ', new Intl.NumberFormat('de-DE', options).format(numNew));
// console.log('Syria:     ', new Intl.NumberFormat('ar-SY', options).format(numNew));
// console.log('Browser:     ', new Intl.NumberFormat('gh-GO', options).format(numNew));
// console.log(
//   navigator.language,
